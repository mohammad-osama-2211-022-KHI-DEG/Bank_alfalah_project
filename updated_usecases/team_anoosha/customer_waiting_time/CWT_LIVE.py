...
NUM_JITTERS = 10
LOG_FILENAME = f'/home/xloop/Downloads/updated_git_code/Bank_alfalah_project/updated_usecases/team_anoosha/customer_waiting_time/output/logs/{FILENAME}.log'
VIDEO_PATH = 0
# VIDEO_PATH = f'/home/zubair/Xloop/bafl/ready_github_code/team_anoosha/customer_waiting_time/video/{FILENAME}.mp4'
OUTPUT_PATH = f'/home/xloop/Downloads/updated_git_code/Bank_alfalah_project/updated_usecases/team_anoosha/customer_waiting_time/output/{FILENAME}_tol_{FACE_RECOGNITION_TOLERANCE}_{TIME_THRESHOLD}sec.mkv'
FOURCC = cv2.VideoWriter_fourcc(*'mp4v')
JWT_TOKEN = "JhbGciOiJIUzI1NiJ9.eyJpc3MiOiJCQUxGIiwic3ViIjoiSldUIFRva2VuIiwidXNlcm5hbWUiOiJtZWhyQGdtYWlsLmNvbSIsImF1dGhvcml0aWVzIjoiQ1JFQVRFX1VTRVIsVklFVyIsImlhdCI6MTcwODU3NjMyMCwiZXhwIjoxNzM0ODQxOTIwfQ.tb5RjpQe0tEfBbXuPmXLrHHAccSFJqlXga4SAxE56sU"
