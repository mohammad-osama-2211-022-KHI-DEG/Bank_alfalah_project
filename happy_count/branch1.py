...
detector = MTCNN()
classifier = load_model('/home/xloop/Bank_Alfalah/Bank_alfalah_project/happy_count/Emotion_Detection.h5')
...
cap = cv2.VideoCapture("/home/xloop/Bank_Alfalah/Bank_alfalah_project/videos/smile.mp4")
            ...
            if previous_emotions[assigned_id] != 'Happy' and label == 'Happy':
                ...
                if happy_count % alert_trigger_interval == 0:
                    ...
                    doc_ref = db.collection('logs').add({
                        ...
                        'usecase': 'smiles_collection' ,
                        'city': 'islamabad',
                        'branch':'jinnah avenue',
                        'country': 'pakistan',
                        'message': str(happy_count) + ' smiles counted'
                        })
