...
def build_payload(formatted_date, level_of_mess, cleanliness_status):
    return {
        "country": "pakistan",
        "branch": "clifton",
        "city": "karachi",
...
def main():
    custom_weights_path = "new_best.pt"
    video_source_path = "Atm_Final.mp4"
    output_video_path = "output_video.mp4"
    endpoint_url = "http://13.233.56.158:5000/cleanliness/{TAG}" 
    tag = "atm"
    jwt_token = "1eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJCQUxGIiwic3ViIjoiSldUIFRva2VuIiwidXNlcm5hbWUiOiJhbmlxYW1hc29vZDExMUBnbWFpbC5jb20iLCJhdXRob3JpdGllcyI6IkNSRUFURV9VU0VSLFZJRVciLCJpYXQiOjE3MDc5MDQ0NDAsImV4cCI6MTczNDE3MDA0MH0.QH8ZgFAWPdEZHfYt3uvw3JShHVijiyniTcdOMxfH9Y8"
    ...
    try:
        for line in yolo_process.stdout:
            ...
            if cleanliness_status != previous_cleanliness_status or level_of_mess != previous_level_of_mess:
                ...
                payload = build_payload(formatted_date, level_of_mess, cleanliness_status)
